...
//	private SessionFactory factory; // se crea al incio, implementa el patron singlenton
//	
//	public EmployeeManager(){
//		factory = new Configuration().configure().buildSessionFactory();
//	}
//	
//	public Long addEmployee (String firstName, String lastName, Date birthdate, double salary, String phone, String email) {
//		Session session = factory.openSession(); //EL OBJETO SESION SE CREA CADA QUE QUIERA EJECUTAR UNA INSTRUCCION A MI BD
//		Transaction tx=null;// INICIA UN BLOQUE DE TRANSACCION, SI EXITE UN ERROR PUEDO LLAMAR A ROLLBACK. SI TODO ESTA OK LLAMO A COMMIT.
//		Long id =null;
//		
//		try {
//			tx = session.beginTransaction();//solo cuando se modifica algo en la base de datos
//			Employee employee = new Employee(firstName, lastName, birthdate, salary, phone, email);
//			session.persist(employee);
//			session.flush(); //llamados asincronos 
//			tx.commit();
//			id = employee.getId();
//		}catch(HibernateException e) {
//			if (tx!=null) tx.rollback();
